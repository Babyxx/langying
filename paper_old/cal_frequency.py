...
uniWordOut = open("./data/idfWU.txt", "w");
biWordOut = open("./data/idfWB.txt", "w");
uniPosOut = open("./data/idfPU.txt", "w");
biPosOut = open("./data/idfPB.txt", "w");
triPosOut = open("./data/idfPT.txt", "w");
